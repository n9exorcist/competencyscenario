            ...
            <div className="each-row book-info" id={book.id} key={book.id}>
                ...
                <div className="content-book-name">
                    <div className="books-content-info-book-record">
                        <a href="# " onClick={e => e.preventDefault()}>{book.name}</a>
                        ...
                        <div className="row review-rating">
                            ...
                            <div className="col-sm-6">
                                <img src="./assets/Comments.png" alt="comments" />&nbsp; {book.reviews.length}&nbsp; customer reviews</div>
                        </div>

                           {/* Enhanced Modal */}
      {/* <NotificationModal show={showModal} onHide={() => setShowModal(false)} book={book} /> */}
                        <div className="price">&#8377;&nbsp;{book.price}</div>
                        <div className="cart-div">
                            <a className="cart" id="cart" href="# " onClick={e => e.preventDefault()}>
                                <img src="../../assets/cart.png" alt="cart" />
                            </a>
                            <a href="# " onClick={e => e.preventDefault()} className="favourite" id="favourite">
                                <img src="../../assets/favorites.png" alt="favourites" />
                            </a>
                            <a href="# " onClick={e => e.preventDefault()} className="view-details" id="view-details">View Details</a>
                        </div>
                    </div>
                </div>
